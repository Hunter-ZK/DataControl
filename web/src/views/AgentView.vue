  ...
  <div class="dc-page"><div class="dc-container agent-page">
    ...
    <div class="agent-layout">
      <section class="dc-card chat-panel">
        <div v-if="contextAsset" class="context-strip"><Database :size="15"/><div><small>当前问数上下文</small><b>{{contextAsset.bizName||contextAsset.tableName}}</b><code>{{contextAsset.tableName}} · {{contextAsset.assetId}}</code></div><button @click="clearContext">清除</button></div>
...
import { ArrowDown, CheckCircle2, Code2, Database, LoaderCircle, Send, ShieldCheck, Sparkles, TriangleAlert, User, Workflow } from 'lucide-vue-next'
import { ElMessage } from 'element-plus'
import { agentApi, assetApi, type AgentActivity, type AgentStatus } from '@/api/client'
