...
export interface AgentResult{sessionId?:string|null;answer:string;stopReason?:string|null;events?:AgentActivity[];sql?:string|null;validation?:unknown;sqlExecuted:boolean;hiddenReasoningExposed:boolean}
